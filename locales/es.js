...
export default {
    ...
    home:{
        ...
        middleBlockTitle: 'Quienes Somos',
        middleBlockContent: HomeMiddleBlockHomeContent,
        cardsTitle: 'Qué estas buscando?',
        cardsTextCardLeft: 'Conviertete en un Explorador de lo Alternativo',
    ...
    join:{
        ...
        headerButtonText:'CONVIERTETE EN UN ExpA',
